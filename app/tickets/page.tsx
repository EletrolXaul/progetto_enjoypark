...
import { CreditCard, QrCode, Calendar, Star, Check, Download, Ticket, User, Mail, Phone } from "lucide-react"
...
export default function TicketsPage() {
  ...
  const ticketTypes = [
    {
      ...
      features: ["Accesso a tutte le attrazioni", "Mappa del parco inclusa", "Valido per un giorno"],
      popular: false,
    },
    {
      id: "premium",
    ...
    },
    {
      ...
      features: ["4 biglietti standard", "Pranzo famiglia incluso", "Area picnic riservata", "Attività per bambini"],
      popular: false,
    },
    {
      id: "season",
      ...
      features: ["Accesso illimitato", "Parcheggio sempre gratuito", "Sconti esclusivi", "Eventi speciali"],
      popular: false,
    },
  ]
   ...
   */
  const addOns = [
    { id: "fastpass", name: "Fast Pass", price: 15, description: "Salta le code nelle attrazioni principali" },
    { id: "meal", name: "Piano Pasti", price: 25, description: "Pranzo e cena inclusi" },
    { id: "photo", name: "Pacchetto Foto", price: 20, description: "Tutte le foto delle attrazioni" },
    { id: "parking", name: "Parcheggio Premium", price: 10, description: "Parcheggio vicino all'ingresso" },
  ]
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-4">
              ...
              <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Biglietti</h1>
            </div>
            <Badge
              variant="outline"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <Tabs defaultValue="purchase" className="w-full">
          <TabsList className="grid w-full grid-cols-2">
            ...
            <TabsTrigger value="mytickets">I Miei Biglietti ({orders.length})</TabsTrigger>
          </TabsList>
              ...
              <div className="grid lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-2 space-y-6">
                  ...
                  <div className="space-y-4">
                    <h2 className="text-xl font-bold text-gray-900 dark:text-white">Scegli i Tuoi Biglietti</h2>
                    {ticketTypes.map((ticket) => (
                      <Card
                        key={ticket.id}
                        className={`relative ${ticket.popular ? "ring-2 ring-blue-500" : ""} dark:bg-gray-800 dark:border-gray-700`}
                      >
                        {/* BADGE POPOLARE */}
                        {ticket.popular && (
                          ...
                          <div className="space-y-4">
                            ...
                            <div className="flex items-center justify-between pt-4 border-t">
                              ...
                              {selectedTickets[ticket.id] > 0 && (
                                <div className="text-right">
                                  <div className="font-bold text-lg">€{ticket.price * selectedTickets[ticket.id]}</div>
                                  <div className="text-sm text-gray-500">
                                    {selectedTickets[ticket.id]} bigliett{selectedTickets[ticket.id] > 1 ? "i" : "o"}
                                  </div>
                                </div>
                              )}
                            </div>
                ...
                <div className="space-y-6">
                  <Card className="sticky top-4 dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <CardContent>
                      {getTotalTickets() === 0 ? (
                        <p className="text-gray-500 text-center py-4">Seleziona i biglietti per vedere il riepilogo</p>
                      ) : (
                        <div className="space-y-4">
                            ...
                            return (
                              <div key={ticketId} className="flex justify-between items-center">
                                <div>
                                  ...
                                  <div className="text-sm text-gray-600 dark:text-gray-400">Quantità: {quantity}</div>
                                </div>
                                <div className="font-bold">€{ticket.price * quantity}</div>
                              </div>
                            )
                          })}
                          ...
                          {!selectedDate && (
                            <p className="text-sm text-red-600 text-center">Seleziona una data per continuare</p>
                          )}
                        </div>
                      )}
                    </CardContent>
              ...
              {orders.length === 0 ? (
                ...
                <Card className="dark:bg-gray-800 dark:border-gray-700">
                  <CardContent className="text-center py-12">
                    ...
                    <p className="text-gray-600 dark:text-gray-400">Acquista i tuoi primi biglietti per iniziare!</p>
                  </CardContent>
                </Card>
              ) : (
                ...
                orders.map((order) => (
                  <Card key={order.id} className="dark:bg-gray-800 dark:border-gray-700">
                    <CardHeader>
                      <div className="flex justify-between items-start">
                        <div>
                          <CardTitle className="text-lg">Ordine #{order.id}</CardTitle>
                          <p className="text-sm text-gray-600 dark:text-gray-400">
                            Acquistato il {new Date(order.purchaseDate).toLocaleDateString("it-IT")}
                          </p>
                        </div>
                    ...
                    <CardContent>
                      <div className="grid md:grid-cols-2 gap-6">
                        {/* DETTAGLI BIGLIETTI */}
                        <div>
                          <h4 className="font-semibold mb-2">Dettagli Biglietti</h4>
                          <div className="space-y-2">
                                ...
                                <div className="space-y-4">
                                  ...
                                  <div className="flex space-x-4 pt-4 border-t">
                                    ...
                                    <Button
                                      className="flex-1"
                                      onClick={() => {
                                        navigator.clipboard.writeText(order.qrCodes.join("\n"))
                                        toast({
                                          title: "Copiato!",
                                          description: "Tutti i QR codes sono stati copiati negli appunti",
                                        })
                                      }}
                                    >
